...
export const mockPublicPagesContent: PublicPagesContent = {
    ...
    faq: {
        ...
        categories: [
            ...
            },
            {
                ...
                items: [
                    { q: "لو عندي استفسار أو مشكلة، أتواصل مع مين؟", a: "واتساب: [ضع الرقم]" }
                ]
            },
            {
    ...
    privacy: {
        ...
        sections: [
            ...
            { title: "9. اتصل بنا", content: ["إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه، يرجى الاتصال بنا عبر زيارة الواتس اب: [رابط اتصل بنا]"] }
        ]
    },
    terms: {
        ...
        sections: [
            ...
            { title: "11. اتصل بنا", content: ["إذا كان لديك أي أسئلة حول هذه الشروط، يرجى الاتصال بنا عبر الواتس اب: [رابط اتصل بنا]"] }
        ]
    }
};
