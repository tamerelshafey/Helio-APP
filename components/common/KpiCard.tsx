...
interface KpiCardProps {
  title: string;
  value: string;
  // FIX: Make change and changeLabel optional to allow for cards without change indicators.
  change?: string;
  changeLabel?: string;
  ...
  return (
    <div className={cardClasses}>
      ...
      <div className="mt-4 text-right">
        ...
        {/* FIX: Conditionally render the change indicator only if change and changeLabel are provided. */}
        {change && changeLabel && (
