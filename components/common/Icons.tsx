...
export const MapPinSolidIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M12 2.25c-4.142 0-7.5 3.358-7.5 7.5 0 4.142 7.5 11.25 7.5 11.25s7.5-7.108 7.5-11.25c0-4.142-3.358-7.5-7.5-7.5zM12 12a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" clipRule="evenodd" />
    </svg>
);

export const PinIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 3.75V16.5L12 21l-4.5-4.5V3.75h9z" />
  </svg>
);
...
export const AppleIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path d="M19.38 11.23c-.27-.03-1.03-.2-1.03 1.16 0 1.3.8 1.93.96 2.03.1.06.1.1.1.1 0 0 .03.03-.1.35-.13.31-.62 1.58-1.22 2.45-.62.87-1.25 1.75-2.22 1.75-.96 0-1.28-.56-2.31-.56-1.03 0-1.42.56-2.34.56-.93 0-1.69-.9-2.31-1.78-.62-.87-1.16-2.14-1.28-2.45-.13-.31-.13-.31-.13-.31s0 0 .1-.1c.16-.1.93-.72.93-2.03 0-1.36-.75-1.19-1.03-1.16-.27.03-.53 0-.72-.03-.21-.03-.62-.16-.9-.5-.27-.34-.44-.78-.44-1.25 0-.9.44-1.72 1.19-2.25.75-.53 1.6-.72 2.31-.75.25 0 .72.03 1.16.03.44 0 .81-.03 1.05-.03.25 0 .75.06 1.19.06.44 0 1.33-.21 2.06-.12.4.06.81.16 1.25.34.44.18.78.34.93.47.21.15.25.18.31.18s.13-.03.34-.18c.09-.06.47-.28.9-.47.44-.18.84-.28 1.25-.34.72-.09 1.62.12 2.06.12.44 0 .93-.06 1.19-.06.25 0 .8-.03 1.05.03.44.03.9.03 1.16-.03.72-.03 1.56.22 2.31.75.75.53 1.19 1.34 1.19 2.25 0 .47-.16.9-.44 1.25-.27.34-.68.47-.9.5-.18.03-.44.06-.72.03zM15.91 4.59c.56-.69 1-1.55 1.03-2.5.03-.28.03-.56.03-.84-.87.03-1.84.44-2.56 1.13-.56.56-.96 1.42-1.03 2.31-.03.28-.03.56-.03.84.93 0 1.84-.44 2.56-1.02.03.06.03.06 0-.08z" />
    </svg>
);

export const ShareIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186l9.566-5.314m-9.566 7.5l9.566 5.314m0 0a2.25 2.25 0 100-2.186m0 2.186c-.18.324-.283.696-.283 1.093s.103.77.283 1.093m0-2.186l-9.566-5.314m9.566 0a2.25 2.25 0 100-2.186m0 2.186c.18-.324.283-.696.283-1.093s-.103-.77-.283-1.093" />
  </svg>
);