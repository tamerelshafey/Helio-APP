...
export const GooglePlayIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M1.333 22.667l12-12-12-12-1.333 1.333 10.667 10.667-10.667 10.667zM14.667.667l-2.667 2.667 4.5 4.5 3.5-3.5-5.333-3.667zM24 12l-5.333 3.667-3.5-3.5 4.5-4.5zM12 12l-1.573-1.573-7.093 7.093 1.573 1.573z" />
    </svg>
);
export const AppleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M19.333 12.333c0-2.207-1.427-4.14-3.5-4.887.053-1.06-.027-2.167-.027-2.167s-2.027-.373-3.8 1.253c-1.147-.64-2.4-1-3.667-1.027-2.88.027-5.333 2.373-5.333 5.307 0 3.427 2.027 6.4 4.56 7.6.8.4 1.653.627 2.507.627.187 0 .373 0 .56-.027.96-.107 1.893-.453 2.693-.987 1.253-.827 2.027-2.027 2.4-3.333h-4.347c0 .001.001 0 .001 0zM12.667.667c.747 0 1.52.187 2.347.533-.32.613-.6 1.24-.827 1.867-.72-.347-1.493-.533-2.293-.533-.293 0-.587.027-.88.053.427-.96.96-1.84 1.653-2.42z" />
    </svg>
);
