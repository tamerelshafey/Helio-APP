...
export const RocketLaunchIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.82m5.84-2.56a12.025 12.025 0 0 1-5.84 7.38m0-7.38a12.025 12.025 0 0 0-5.84-7.38m5.84 7.38v-4.82l-1.5-1.5a1.5 1.5 0 0 1-2.12 0l-1.5 1.5v4.82m0 0a12.025 12.025 0 0 1-5.84-7.38m5.84 7.38a6 6 0 0 1-5.84-7.38m0 7.38L9 12.75a1.5 1.5 0 0 1 2.12 0l1.5 1.5m0 0v-4.82m0 0a12.025 12.025 0 0 1 5.84-7.38m-5.84 7.38a6 6 0 0 1 5.84-7.38" />
  </svg>
);