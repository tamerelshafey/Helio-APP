...
const TransportationManagerDashboard: React.FC = () => {
    ...
    const stats = useMemo(() => {
        ...
        const override = scheduleOverrides.find(o => o.date === todayDateString);
        const driversOnDuty = override 
            ? override.drivers 
            : weeklySchedule.find(d => d.day === dayOfWeek)?.drivers || [];

        return {
            internalDriversCount: internalDrivers.length,
            externalRoutesCount: externalRoutes.length,
            driversOnDuty
        };
    }, [internalDrivers, externalRoutes, weeklySchedule, scheduleOverrides]);
            ...
            <div className="space-y-6 animate-fade-in">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg flex flex-col justify-center items-center">
                        ...
                        <Link to="/dashboard/transportation" className="flex flex-col items-center justify-center gap-2 bg-cyan-500 text-white font-semibold px-8 py-4 rounded-lg hover:bg-cyan-600 transition-colors">
